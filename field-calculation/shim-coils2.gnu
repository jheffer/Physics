set title "East/west shim coils: 83 cm x 180 cm, spacing 83 cm,\n20 turns, 0.181 A (y = 0, z = 0)"
set xlabel "Position x/m"
set ylabel "Magnetic field strength/Gauss"
#set xrange [-0.01:0.01]

set output "shim-coils2.ps"
...
Be = -6.692*1e-3 # earth's magnetic field (total)/G
...
plot \
Be t "|B_{Earth (E/W)}|" lt rgb "#660066",\
"shim-coils2.txt" u 1:(sqrt($4**2+$5**2+$6**2)*Bscale) t "|B|" pt 7 ps 0.2,\
"shim-coils2.txt" u 1:($4*Bscale) t "B_x" pt 7 ps 0.2 lt rgb "red",\
"shim-coils2.txt" u 1:($5*Bscale) t "B_y" pt 7 ps 0.2 lt rgb "green",\
"shim-coils2.txt" u 1:($6*Bscale) t "B_z" pt 7 ps 0.2 lt rgb "blue"
