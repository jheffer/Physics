...
Be = -6.692*1e-3*1e-4 # earth's magnetic field (total)/T
...
"shim-EW.txt" u 1:(sqrt($4**2+$5**2+$6**2)*Bscale) t "|B|" pt 7 ps 0.2,\
"shim-EW.txt" u 1:($4*Bscale) t "B_x" pt 7 ps 0.2 lt rgb "red",\
"shim-EW.txt" u 1:($5*Bscale) t "B_y" pt 7 ps 0.2 lt rgb "green",\
"shim-EW.txt" u 1:($6*Bscale) t "B_z" pt 7 ps 0.2 lt rgb "blue"
