set title "Coil pair, 20 cm spacing, 5 cm radius, 20 turns, 10 mA (y = 0, z = 0)"
set xlabel "Position x/m"
set ylabel "Magnetic field strength/mG"

set output "twocoils-N20.ps"
...
#b = 1e-30
#c = 20
#fit [-0.05:0.05] f(x) "twocoils-N20.txt" u 1:(($2==0 & $3==0) ? (sqrt($4**2+$5**2+$6**2)*Bscale):NaN) via a,b,c

# Plot only where y=0 and z=0
plot\
"twocoils-N20.txt" u 1:(($2==0 & $3==0) ? (sqrt($4**2+$5**2+$6**2)*Bscale):NaN) t "|B|" pt 7 ps 0.2,\
"twocoils-N20.txt" u 1:(($2==0 & $3==0) ? ($4*Bscale):NaN) t "B_x" pt 7 ps 0.2 lt rgb "red",\
"twocoils-N20.txt" u 1:(($2==0 & $3==0) ? ($5*Bscale):NaN) t "B_y" pt 7 ps 0.2 lt rgb "green",\
"twocoils-N20.txt" u 1:(($2==0 & $3==0) ? ($6*Bscale):NaN) t "B_z" pt 7 ps 0.2 lt rgb "blue"
